...
DMA_HandleTypeDef hdma_sai1_a = {.Instance = DMA2_CHANNEL_SAI_RX,
...
DMA_HandleTypeDef hdma_sai1_b = {.Instance = DMA2_CHANNEL_SAI_TX,
...
static void sai_dma_start_it(DMA_HandleTypeDef *hdma, uint32_t source_addr, uint32_t destination_addr,
                             uint32_t sample_count, sai_direction_t direction);
...
{
    uint8_t payload[2] = {mem_addr, data};
...
void evk_audio_sai_write_non_blocking(uint8_t *data, uint16_t size)
{
    ...
    sai_dma_start_it(&hdma_sai1_b, (uint32_t)data, (uint32_t)&hsai_block_b1.Instance->DR, sample_count,
                     SAI_MCU_TO_CODEC);
...
void evk_audio_sai_read_non_blocking(uint8_t *data, uint16_t size)
{
    ...
    sai_dma_start_it(&hdma_sai1_a, (uint32_t)&hsai_block_a1.Instance->DR, (uint32_t)data, sample_count,
                     SAI_CODEC_TO_MCU);
...
static void init_audio_sai_gpios(void)
{
    GPIO_InitTypeDef mc0_config = {.Pin = AUDIO_MCO_CLK_PIN,
    ...
    GPIO_InitTypeDef clk_in_config = {.Pin = AUDIO_SAI_IN_CLK_PIN,
                                      .Mode = GPIO_MODE_AF_PP,
                                      .Pull = GPIO_NOPULL,
                                      .Speed = GPIO_SPEED_FREQ_MEDIUM,
    ...
    GPIO_InitTypeDef mclk_config = {.Pin = AUDIO_SAI_MCLK_PIN,
                                    .Mode = GPIO_MODE_AF_PP,
                                    .Pull = GPIO_NOPULL,
    ...
    GPIO_InitTypeDef sck_config = {.Pin = AUDIO_SAI_SCK_PIN,
                                   .Mode = GPIO_MODE_AF_PP,
                                   .Pull = GPIO_NOPULL,
    ...
    GPIO_InitTypeDef fs_config = {.Pin = AUDIO_SAI_FS_PIN,
                                  .Mode = GPIO_MODE_AF_PP,
                                  .Pull = GPIO_NOPULL,
                                  .Speed = GPIO_SPEED_FREQ_HIGH,
                                  .Alternate = GPIO_AF14_SAI1};
    ...
    GPIO_InitTypeDef sda_config = {.Pin = AUDIO_SAI_SD_A_PIN,
                                   .Mode = GPIO_MODE_AF_PP,
                                   .Pull = GPIO_NOPULL,
                                   .Speed = GPIO_SPEED_FREQ_HIGH,
                                   .Alternate = GPIO_AF14_SAI1};
    ...
    GPIO_InitTypeDef sdb_config = {.Pin = AUDIO_SAI_SD_B_PIN,
                                   .Mode = GPIO_MODE_AF_PP,
                                   .Pull = GPIO_NOPULL,
                                   .Speed = GPIO_SPEED_FREQ_HIGH,
...
static void init_audio_i2c_gpios(void)
{
    GPIO_InitTypeDef scl_i2c_config = {.Pin = AUDIO_I2C_SCL_PIN,
    ...
    GPIO_InitTypeDef sda_i2c_config = {.Pin = AUDIO_I2C_SDA_PIN,
                                       .Mode = GPIO_MODE_AF_OD,
                                       .Pull = GPIO_NOPULL,
                                       .Speed = GPIO_SPEED_FREQ_LOW,
                                       .Alternate = GPIO_AF4_I2C1};
