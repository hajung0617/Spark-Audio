...
if not exist "%MAMBA_ROOT_PREFIX%\packs\Keil.STM32G4xx_DFP.1.5.0.pack" (
    ...
    call %POWERSHELL% -Command Set-Variable ProgressPreference SilentlyContinue; Invoke-Webrequest -URI https://keilpack.azureedge.net/pack/Keil.STM32G4xx_DFP.1.5.0.pack -OutFile %MAMBA_ROOT_PREFIX%\packs\Keil.STM32G4xx_DFP.1.5.0.pack
)
