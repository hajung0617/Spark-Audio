...
/* CONSTANTS ******************************************************************/
#define TIMER_SELECTION_AUDIO_PROCESS    EVK_TIMER_SELECTION_TIMER20
#define TIMER_SELECTION_DATA             EVK_TIMER_SELECTION_TIMER3

#define IRQ_PRIORITY_TIMER_AUDIO_PROCESS 14
...
{
    evk_timer_start(TIMER_SELECTION_AUDIO_PROCESS);
}

void facade_audio_process_timer_trigger(void)
{
    evk_timer_generate_event(TIMER_SELECTION_AUDIO_PROCESS);
}

void facade_audio_process_timer_stop(void)
{
    evk_timer_stop(TIMER_SELECTION_AUDIO_PROCESS);
}
