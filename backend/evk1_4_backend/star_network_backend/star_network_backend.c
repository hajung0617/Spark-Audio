...
{
    /* On normal press, the button SW2 of the EVK1.4 send the button state to the Coord. */
    return evk_read_btn_state(BTN2);
}

bool facade_coord_read_user_button_1_state(void)
{
    /* On normal press, the button SW1 of the EVK1.4 send the button state to the Node. */
    return evk_read_btn_state(BTN1);
}

bool facade_coord_read_user_button_2_state(void)
{
    /* On normal press, the button SW2 of the EVK1.4 send the button state to the Node. */
    return evk_read_btn_state(BTN2);
}
